...
# credit: https://github.com/owseaman/Building-up-my-image-classifier/blob/master/dnn_app_utils_v2.py
...
def linear_activation_backward(dA, cache, activation):
    ...
    back_activation_func = sigmoid_backward if activation == 'sigmoid' else relu_backward

    dZ = back_activation_func(dA, cache)
...
def linear_activation_backward(dA, cache, activation):
    ...
    linear_cache, activation_cache = cache
    dZ = back_activation_func(dA, activation_cache)
